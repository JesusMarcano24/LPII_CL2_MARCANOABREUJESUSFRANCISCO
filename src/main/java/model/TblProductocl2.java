...
public class TblProductocl2 implements Serializable {
	...
	private float preciocompcl2;

	private float precioventacl2;
	...
	public float getPreciocompcl2() {
		return this.preciocompcl2;
	}

	public void setPreciocompcl2(float preciocompcl2) {
		this.preciocompcl2 = preciocompcl2;
	}

	public float getPrecioventacl2() {
		return this.precioventacl2;
	}

	public void setPrecioventacl2(float precioventacl2) {
